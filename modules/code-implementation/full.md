...
A forced special case is not a routine implementation detail. Try to reshape it into the normal case; if the accepted constraints still force an exception, stop and report the design choice instead of burying it.
